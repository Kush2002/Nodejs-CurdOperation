...
exports.adminlogout = exports.admin = void 0;
...
var adminlogout = exports.adminlogout = /*#__PURE__*/function () {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addClient.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addTask = exports.addClient = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var addClient = exports.addClient = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, username, password, email, phone, address) {
    var result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"editClient.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var editClient = exports.editClient = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, name, username, password, email, phone, address) {
    var result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:6001/api/user/".concat(id),
            data: {
              id: id,
              name: name,
              username: username,
  ...
  return function editClient(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"deleteClientData .js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteClientData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var deleteClientData = exports.deleteClientData = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (result.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Client Deleted Successfully');
            window.setTimeout(function () {
              location.reload();
            }, 2000);
          }
  ...
  return function deleteClientData(_x) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"showTask.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showTask = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var showTask = exports.showTask = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(projectId, empName) {
    var result, html, data, emp, i, formattedEndDate, rowid;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 3:
          ...
          if (result.data.status === 'success') {
            ...
            emp = result.data.data.getTask.employeeName;
  ...
  return function showTask(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"employee.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.empLogout = exports.empLogin = exports.editEmployee = exports.deleteEmployee = exports.add_employee = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var empLogin = exports.empLogin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(empEmail, password) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function empLogin(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var empLogout = exports.empLogout = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
  ...
  return function empLogout() {
    return _ref2.apply(this, arguments);
  };
}();
var add_employee = exports.add_employee = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(empId, empName, empEmail, password, empPhone, empAddress) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          // console.log(res);
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Employee Create Successfully');
            window.setTimeout(function () {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', "".concat(_context3.t0.response.data.message));
          window.setTimeout(function () {
            Location.assign('/');
          }, 1000);
        case 11:
  ...
  return function add_employee(_x3, _x4, _x5, _x6, _x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();
var editEmployee = exports.editEmployee = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, empId, empName, empEmail, empPhone, empAddress) {
    var result;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:6001/api/employee/updateEmployee/".concat(id),
            data: {
              id: id,
              empId: empId,
              empName: empName,
        ...
        case 3:
          ...
          // console.log(result);
          if (result.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Employee Updated Successfully');
            window.setTimeout(function () {
              location.assign('/employee');
            }, 1000);
          }
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', "".concat(_context4.t0.response.data.message));
        case 10:
        case "end":
  ...
  return function editEmployee(_x9, _x10, _x11, _x12, _x13, _x14) {
...
var deleteEmployee = exports.deleteEmployee = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:6001/api/employee/deleteEmployee/".concat(id),
            data: {
              id: id
            }
          });
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Employee Deleted Successfully');
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', "".concat(_context5.t0.response.data.message));
        case 11:
        case "end":
  ...
  return function deleteEmployee(_x15) {
...
var addProject = exports.addProject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(projectName, description, startDates, endDates, username, empName, notes) {
    var result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"editProjectData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editProjectData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var editProjectData = exports.editProjectData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, projectName, description, startDates, endDates, username, empName, notes) {
    var result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:6001/api/project/".concat(id),
            data: {
              id: id,
              projectName: projectName,
              description: description,
        ...
        case 3:
          ...
          // console.log(result);
          if (result.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Project Updated Successfully');
            window.setTimeout(function () {
              location.assign('/project');
            }, 1000);
          }
  ...
  return function editProjectData(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"deleteProjectData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteProjectData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var deleteProjectData = exports.deleteProjectData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log('result', res);
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Project Deleted Successfully');
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
  ...
  return function deleteProjectData(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _addClient = require("./addClient");
var _editClient = require("./editClient");
var _deleteClientData = require("./deleteClientData ");
var _showTask = require("./showTask");
var _employee = require("./employee");
var _addProject = require("./addProject");
var _editProjectData = require("./editProjectData");
var _deleteProjectData = require("./deleteProjectData");
// ==========  ADMIN  ==========
...
$(document).on('submit', '#adminForm', function (e) {
  ...
  (0, _admin.admin)(username, password);
});
...
$(document).on('submit', '#add_form', function (e) {
  ...
  (0, _addClient.addClient)(name, username, password, email, phone, address);
});
...
$(document).on('submit', '#update_user', function (e) {
  ...
  (0, _editClient.editClient)(id, name, username, password, email, phone, address);
});
...
$(document).on('click', '#delete_user', function (e) {
  ...
  var id = $(this).data('id');
  // console.log('id',id);
  (0, _deleteClientData.deleteClientData)(id);
});
...
$(document).on('submit', '#employee_login', function (e) {
  ...
  (0, _employee.empLogin)(empEmail, password);
});
...
$(document).on('click', '#empOut', function (e) {
  e.preventDefault();
  console.log('logout');
  (0, _employee.empLogout)();
});

// ADD EMPLOYEE
$(document).on('submit', '#employee_form', function (e) {
  e.preventDefault();
  var empId = $(this).find('input[name=employeeID]').val();
  var empName = $(this).find('input[name=employeeName]').val();
  var empEmail = $(this).find('input[name=employeeEmail]').val();
  var password = $(this).find('input[name=password]').val();
  var empPhone = $(this).find('input[name=employeePhone]').val();
  var empAddress = $(this).find('input[name=employeeAddress]').val();
  console.log(empId, empName, empEmail, password, empPhone, empAddress);
  (0, _employee.add_employee)(empId, empName, empEmail, password, empPhone, empAddress);
});
...
$(document).on('submit', '#employee_edit', function (e) {
  ...
  (0, _employee.editEmployee)(id, empId, empName, empEmail, empPhone, empAddress);
});
...
$(document).on('submit', '#project_form', function (e) {
  ...
  var startDates = $(this).find('input[name=startDates]').val();
  var endDates = $(this).find('input[name=endDates]').val();
  var username = $(this).find('select[name=username]').val();
  var empName = [];
  $(this).find('input[name=employeeCheckbox]:checked').each(function () {
  ...
  (0, _addProject.addProject)(projectName, description, startDates, endDates, username, empName, notes);
});
