...
// ==========  EMPLOYEE  ==========
import {empLogin,empLogout, add_employee,editEmployee, deleteEmployee } from './employee';
...
$(document).on('submit','#task_add', function (e){
  ...
  addTask(taskName, employeeName, description, endDates);
});
...
$(document).on('submit', '#project_form', function (e) {
  ...
  addProject(projectName, description, startDates, endDates, username, empName, notes);
});
...
$(document).on('submit', '#update_project', function (e) {
  ...
  editProjectData(id,projectName, description, startDates, endDates, username, empName, notes);
});
